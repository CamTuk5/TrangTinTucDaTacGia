...
return new class extends Migration
{
    public function up(): void
    {
        ...
        throw_if($teams && empty($columnNames['team_foreign_key'] ?? null), \Exception::class, 'Error: team_foreign_key not loaded. Run [php artisan config:clear] and try again.');
    ...
    public function down(): void
    {
        ...
        throw_if(empty($tableNames), \Exception::class, 'Error: config/permission.php not found. Drop tables manually.');
